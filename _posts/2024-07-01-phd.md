...
There's sometimes a perception that if you're in industry, you can't do "real" research. Having to defend research choices to federal agencies, justify methods to practicing engineers, and see models fail in real-world applications made the science _better_. My dissertation wasn't a set of theoretical exercises - it was battle-tested frameworks that USGS, the Navy, and state agencies actually use.
